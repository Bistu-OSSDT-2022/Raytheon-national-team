...
public class StartUI extends JFrame
{
    ...
    JButton game1=new JButton("单人游戏——人类先手");
    JButton game2=new JButton("单人游戏——电脑先手");
    JButton game3=new JButton("开始双人游戏");
    JButton exit=new JButton("退出游戏");
    JLabel label=new JLabel("欢迎来到海梦五子棋");
    ...
    {
        this.setTitle("海梦五子棋");
        int window_width = 1038;
        int window_height = 923;
    ...
    class ImagePanel extends JPanel
    {
        protected void paintComponent(Graphics g)
        {
            ...
            ImageIcon icon = new ImageIcon("Gobang/设计模式五子棋/img/背景图片.jpeg");
